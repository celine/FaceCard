...
import com.android.facecard.BuildConfig;
...
public class DiskLruCache {
	...
	private static String LOG_TAG = "DiskLruCache";
	...
	public static DiskLruCache openCache(Context context, File cacheDir,
		...
		Log.d("AAAA", "dir " + cacheDir.getPath() + " " + cacheDir.canWrite());
	...
	public Bitmap get(String key, int targetW, int targetH) {
		synchronized (mLinkedHashMap) {
			...
			if (file != null) {
				...
				Log.d("AAAA", "file exists " + new File(file).exists());
				fileExists = true;
